...
int board_init(void)
{
	...
	gd->bd->bi_boot_params = (0x80000000 + 0x100); /* boot param addr */
        ...
        sr32(0x48055134,22,1,0); //setting gpio 54 as output and give high        
        sr32(0x4805513c,22,1,0);
        //sr32(0x4805513c,22,1,1);
        sr32(0x48055134,7,1,1); //setting gpio 39 as input for detect u-boot
        //tmp=__raw_readl(0x4805513c);
        //printf("debug read GPIO 54 output: %lx \n",tmp);
#endif        
	return 0;
}
